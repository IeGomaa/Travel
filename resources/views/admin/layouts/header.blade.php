...
{{--                </li>--}}
                ...
                <li class="menu">
                    <a href="{{ route('admin.testimonial.index') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
...
{{--                </li>--}}
                ...
                <li class="menu">
                    <a href="{{ route('admin.employee.index') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="{{ route('admin.destination.index') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="{{ route('admin.tour.index') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
                ...
                <li class="menu">
                    <a href="{{ route('admin.travel.index') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
